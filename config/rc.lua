...
myarchmenu = {
	...
	{ "Music", myarchmenumusic },
	{ "Graphics", myarchmenugraphics },
	{ "File managers", myarchmenumanagers },
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Control", modkey }, "h", function () awful.util.spawn("gksudo pm-suspend-hybrid & xscreensaver-command -lock") end), -- Hibernate
    awful.key({ }, "Print",               function () awful.util.spawn("scrot '%Y-%m-%d_%H:%M:%S_$wx$h.png' -e 'mv $f ~/Screenshots'") end), -- Print Screen

    --volume
    awful.key({ }, "XF86AudioRaiseVolume",     function () awful.util.spawn("amixer set Master 2%+") end), -- Raise volume
    awful.key({ }, "XF86AudioLowerVolume",     function () awful.util.spawn("amixer set Master 2%-") end), -- Lower volume
    awful.key({ "Control", modkey }, "Up",      function () awful.util.spawn("amixer set Master 2%+") end), -- Raise volume
    awful.key({ "Control", modkey }, "Down",    function () awful.util.spawn("amixer set Master 2%-") end), -- Lower volume
    awful.key({ }, "XF86AudioMute",            function () awful.util.spawn("amixer set Master toggle") end), -- Toggle mute

    --keyboard blacklight
    awful.key({ }, "XF86MonBrightnessUp",      function () awful.util.spawn("xbacklight -inc 2") end), -- increase
    awful.key({ }, "XF86MonBrightnessDown",    function () awful.util.spawn("xbacklight -dec 2") end), -- decrease
